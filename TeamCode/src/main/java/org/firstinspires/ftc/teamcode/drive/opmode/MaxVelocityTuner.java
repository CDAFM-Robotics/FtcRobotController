...
public class MaxVelocityTuner extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        double effectiveKf = Bot8BitDriveConstants.getMotorVelocityF(veloInchesToTicks(maxVelocity));
    ...
    private double veloInchesToTicks(double inchesPerSec) {
        return inchesPerSec / (2 * Math.PI * Bot8BitDriveConstants.WHEEL_RADIUS) / Bot8BitDriveConstants.GEAR_RATIO * Bot8BitDriveConstants.TICKS_PER_REV;
    }
}
